class fortuneComments {
  static comments = [
    ...
    "疑念は裏切り者であり これのせいで挑戦する事をおそれ\n勝ち取ることのできたはずの成果を失ってしまう\n \\- ウイリアム・シェイクスピア -",
